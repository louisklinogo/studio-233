		...
		>
			...
			<div className="flex items-center justify-center space-x-1 mt-1">
				...
				<Button size="sm" className="h-6 w-6 p-0" onClick={skipBackward}>
					<SwissIcons.SkipBack className="h-3 w-3" />
				</Button>

				{/* Play/Pause */}
				<Button size="sm" className="h-6 w-6 p-0" onClick={togglePlayPause}>
					{video.isPlaying ? (
						<SwissIcons.Pause className="h-3 w-3" />
					) : (
						<SwissIcons.Play className="h-3 w-3" />
					)}
				</Button>
				...
				<Button size="sm" className="h-6 w-6 p-0" onClick={skipForward}>
					<SwissIcons.SkipForward className="h-3 w-3" />
				</Button>

				{/* Mute button - hidden but preserved */}
				<Button size="sm" className="h-6 w-6 p-0 hidden" onClick={toggleMute}>
					{video.muted ? (
						<SwissIcons.Mute className="h-3 w-3" />
					) : (
						<SwissIcons.Volume className="h-3 w-3" />
					)}
				</Button>
