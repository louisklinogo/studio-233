...
export const WorkflowEngine: React.FC = () => {
	return (
		<section className="w-full h-screen bg-[#f4f4f0] relative overflow-hidden flex flex-col items-center justify-center p-8 lg:p-24 border-y border-neutral-200/60">
			...
			<div className="w-full h-full max-w-[1400px] border border-neutral-200/80 shadow-[0_40px_100px_rgba(0,0,0,0.04)] rounded-sm overflow-hidden bg-white relative z-10 group transition-all duration-700 hover:shadow-[0_60px_120px_rgba(0,0,0,0.06)]">
				<WorkflowCanvas />
			</div>
